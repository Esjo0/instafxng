...
function client_group_query($client_group, $campaign_type) {
    ...
    if($campaign_type == 1) {
        ...
        switch ($client_group) {
            ...
            case '7': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user AS u WHERE (u.password IS NULL OR u.password = '') AND u.created < DATE_SUB(NOW(), INTERVAL 2 MONTH) AND u.campaign_subscribe = '1'"; break;
            ...
            case '47': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user AS u INNER JOIN user_ifxaccount AS ui ON u.user_code = ui.user_code WHERE (STR_TO_DATE(u.created, '%Y-%m-%d') BETWEEN '$from_date' AND '$to_date') AND ui.user_code = u.user_code AND ui.type = '1' AND u.campaign_subscribe = '1' GROUP BY u.email "; break;
            ...
            case '51': $query = "SELECT u.first_name, u.email, u.phone, u.status, u.user_code, ud.order_complete_time FROM user_deposit AS ud INNER JOIN user_ifxaccount AS ui ON ud.ifxaccount_id = ui.ifxaccount_id INNER JOIN user AS u ON ui.user_code = u.user_code WHERE ud.status = '8' AND u.user_code NOT IN (SELECT u.user_code FROM user_deposit AS ud INNER JOIN user_ifxaccount AS ui ON ud.ifxaccount_id = ui.ifxaccount_id INNER JOIN user AS u ON ui.user_code = u.user_code WHERE ud.status = '8' AND STR_TO_DATE(ud.order_complete_time, '%Y-%m-%d') BETWEEN '2018-03-22' AND '$date_today') GROUP BY u.user_code "; break;
            case '52': $query = "SELECT user.user_code, user.first_name, user.email, campaign_leads.phone FROM campaign_leads, user WHERE(STR_TO_DATE(campaign_leads.created, '%Y-%m-%d') BETWEEN '2018-04-01' AND '2018-04-30') AND campaign_leads.email = user.email AND campaign_leads.interest = '2' GROUP BY user.email"; break;
            case '53': $query = "SELECT u.first_name, u.email, u.phone, u.status, u.user_code, ud.order_complete_time FROM user_deposit AS ud INNER JOIN user_ifxaccount AS ui ON ud.ifxaccount_id = ui.ifxaccount_id INNER JOIN user AS u ON ui.user_code = u.user_code WHERE ud.status = '8' AND STR_TO_DATE(ud.order_complete_time, '%Y-%m-%d') BETWEEN '2018-06-01' AND '2018-06-30' GROUP BY u.user_code "; break;
            case '54': $query = "SELECT u.first_name, u.email, u.phone, u.status, u.user_code, uw.created FROM user_withdrawal AS uw INNER JOIN user_ifxaccount AS ui ON uw.ifxaccount_id = ui.ifxaccount_id INNER JOIN user AS u ON ui.user_code = u.user_code WHERE uw.status = '7' AND STR_TO_DATE(uw.created, '%Y-%m-%d') BETWEEN '2018-06-01' AND '2018-06-30'  GROUP BY u.user_code "; break;
        ...
        switch ($client_group) {
            case '1': $query = "SELECT user_code, first_name, email, phone FROM user WHERE campaign_subscribe = '1' GROUP BY user_code"; break;
            case '2': $query = "SELECT user_code, first_name, email, phone FROM user WHERE (STR_TO_DATE(created, '%Y-%m-%d') BETWEEN '$from_date' AND '$to_date') AND campaign_subscribe = '1' GROUP BY user_code"; break;
            case '3': $query = "SELECT first_name, email, phone FROM free_training_campaign GROUP BY phone"; break;
            case '4': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user_verification AS uv INNER JOIN user AS u ON uv.user_code = u.user_code WHERE (uv.phone_status = '2') AND u.campaign_subscribe = '1' GROUP BY u.user_code"; break;
            case '5': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user_credential AS uc INNER JOIN user AS u ON uc.user_code = u.user_code WHERE (uc.doc_status = '111') AND u.campaign_subscribe = '1' GROUP BY u.user_code"; break;
            case '6': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user_bank AS ub INNER JOIN user AS u ON ub.user_code = u.user_code WHERE (ub.is_active = '1' AND ub.status = '2') AND u.campaign_subscribe = '1' GROUP BY u.user_code"; break;
            case '7': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user AS u WHERE (u.password IS NULL OR u.password = '') AND u.created < DATE_SUB(NOW(), INTERVAL 2 MONTH) AND u.campaign_subscribe = '1' GROUP BY u.user_code"; break;
            ...
            case '9': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user AS u INNER JOIN user_meta AS um ON u.user_code = um.user_code LEFT JOIN state AS s ON um.state_id = s.state_id WHERE u.campaign_subscribe = '1' AND um.address LIKE '%Lagos%' GROUP BY u.user_code"; break;
            ...
            case '14': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM sales_contact_client_interest AS scci INNER JOIN user AS u ON scci.user_code = u.user_code WHERE scci.interest_training = '2' GROUP BY u.user_code"; break;
            case '15': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM sales_contact_client_interest AS scci INNER JOIN user AS u ON scci.user_code = u.user_code WHERE scci.interest_funding = '2' GROUP BY u.user_code"; break;
            case '16': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM sales_contact_client_interest AS scci INNER JOIN user AS u ON scci.user_code = u.user_code WHERE scci.interest_bonus = '2' GROUP BY u.user_code"; break;
            ...
            case '29': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM point_ranking_log AS prl INNER JOIN user AS u ON prl.user_code = u.user_code WHERE prl.position IN ('1', '2', '3', '4', '5') AND prl.start_date BETWEEN '2016-12-01' AND '2017-10-01' GROUP BY user_code"; break;
            case '30': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM trading_commission AS td INNER JOIN user_ifxaccount AS ui ON td.ifx_acct_no = ui.ifx_acct_no INNER JOIN user AS u ON ui.user_code = u.user_code WHERE (td.date_earned BETWEEN '2016-12-01' AND '2017-11-30') AND u.user_code NOT IN (SELECT prl.user_code FROM point_ranking_log AS prl WHERE prl.position IN ('1', '2', '3', '4', '5') AND prl.start_date BETWEEN '2016-12-01' AND '2017-10-01' GROUP BY user_code) GROUP BY u.user_code"; break;
            case '31': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user_edu_exercise_log AS ueel INNER JOIN user AS u ON ueel.user_code = u.user_code LEFT JOIN user_edu_fee_payment AS uefp ON ueel.user_code = uefp.user_code WHERE ueel.lesson_id = 5 AND uefp.user_code IS NULL GROUP BY u.user_code"; break;
            case '32': $query = "SELECT full_name AS first_name, email, phone FROM dinner_2017 WHERE attended = '1' GROUP BY u.phone"; break;
            case '33': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user_deposit AS ud INNER JOIN user_ifxaccount AS ui ON ud.ifxaccount_id = ui.ifxaccount_id INNER JOIN user AS u ON ui.user_code = u.user_code WHERE ud.deposit_origin IN ('2', '3') GROUP BY u.user_code"; break;
            case '34': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user_verification AS uv INNER JOIN user AS u ON u.user_code = uv.user_code WHERE uv.user_code = u.user_code AND u.password IS NULL GROUP BY u.user_code"; break;
            ...
            case '46': $query = "SELECT full_name AS first_name, email FROM article_visitors "; break;
            case '47': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user AS u INNER JOIN user_ifxaccount AS ui ON u.user_code = ui.user_code WHERE (STR_TO_DATE(u.created, '%Y-%m-%d') BETWEEN '$from_date' AND '$to_date') AND ui.user_code = u.user_code AND ui.type = '1' AND u.campaign_subscribe = '1' GROUP BY u.user_code "; break;
            case '48': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user AS u LEFT JOIN user_ifxaccount AS ui ON u.user_code = ui.user_code LEFT JOIN free_training_campaign AS ftc ON u.email = ftc.email WHERE (STR_TO_DATE(u.created, '%Y-%m-%d') BETWEEN '$from_date' AND '$to_date') AND ui.user_code IS NULL AND ftc.email IS NULL AND u.campaign_subscribe = '1' GROUP BY u.user_code "; break;
            case '49': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user AS u LEFT JOIN user_ifxaccount AS ui ON u.user_code = ui.user_code LEFT JOIN free_training_campaign AS ftc ON u.email = ftc.email WHERE (STR_TO_DATE(u.created, '%Y-%m-%d') BETWEEN '$from_date' AND '$to_date') AND ui.user_code IS NULL AND ftc.email IS NOT NULL AND u.campaign_subscribe = '1' GROUP BY u.user_code "; break;
            case '50': $query = "SELECT u.user_code, u.first_name, u.email, u.phone FROM user AS u LEFT JOIN user_ifxaccount AS ui ON u.user_code = ui.user_code LEFT JOIN user_deposit AS ud ON ui.ifxaccount_id = ud.ifxaccount_id WHERE (STR_TO_DATE(u.created, '%Y-%m-%d') BETWEEN '$from_date' AND '$to_date') AND u.user_code = ui.user_code AND ui.ifxaccount_id = ud.ifxaccount_id AND ud.real_dollar_equivalent < 50.00 AND u.campaign_subscribe = '1' GROUP BY u.user_code "; break;
            case '51': $query = "SELECT u.first_name, u.email, u.phone, u.status, u.user_code, ud.order_complete_time FROM user_deposit AS ud INNER JOIN user_ifxaccount AS ui ON ud.ifxaccount_id = ui.ifxaccount_id INNER JOIN user AS u ON ui.user_code = u.user_code WHERE ud.status = '8' AND u.user_code NOT IN (SELECT u.user_code FROM user_deposit AS ud INNER JOIN user_ifxaccount AS ui ON ud.ifxaccount_id = ui.ifxaccount_id INNER JOIN user AS u ON ui.user_code = u.user_code WHERE ud.status = '8' AND STR_TO_DATE(ud.order_complete_time, '%Y-%m-%d') BETWEEN '2018-03-22' AND '$date_today') GROUP BY u.user_code "; break;
            case '52': $query = "SELECT user.user_code, user.first_name, user.email, campaign_leads.phone FROM campaign_leads, user WHERE(STR_TO_DATE(campaign_leads.created, '%Y-%m-%d') BETWEEN '2018-04-01' AND '2018-04-30')AND campaign_leads.email = user.email AND campaign_leads.interest = '2' GROUP BY user.user_code "; break;
            case '53': $query = "SELECT u.first_name, u.email, u.phone, u.status, u.user_code, ud.order_complete_time FROM user_deposit AS ud INNER JOIN user_ifxaccount AS ui ON ud.ifxaccount_id = ui.ifxaccount_id INNER JOIN user AS u ON ui.user_code = u.user_code WHERE ud.status = '8' AND STR_TO_DATE(ud.order_complete_time, '%Y-%m-%d') BETWEEN '2018-06-01' AND '2018-06-30'  GROUP BY u.user_code"; break;
			case '54': $query = "SELECT u.first_name, u.email, u.phone, u.status, u.user_code, uw.created FROM user_withdrawal AS uw INNER JOIN user_ifxaccount AS ui ON uw.ifxaccount_id = ui.ifxaccount_id INNER JOIN user AS u ON ui.user_code = u.user_code WHERE uw.status = '7' AND STR_TO_DATE(uw.created, '%Y-%m-%d') BETWEEN '2018-06-01' AND '2018-06-30'  GROUP BY u.user_code"; break;
			default: $query = false; break;
        }
