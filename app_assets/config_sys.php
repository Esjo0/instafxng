...
$client_group_DEFAULT = array(
    ...
    "55" => "All inactive trading clients after January 1 2017.",
	...
	"68" => "Client with complete deposit in current month"
);
$client_group_DESC = array(
	...
	"68" => "All clients who have successfuly completed deposit in the current month from the first day till today."
    );
