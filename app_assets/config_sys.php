...
$client_group_DEFAULT = array(
    ...
    "6" => "Level 3 Clients*Clients who have registered under our loyality program",
    ...
    "23" => "Top 20 Rank in Current Loyalty Year*Consist of the first 20 clients in the loyality program for the running year",
