...
$query = "SELECT trans_id FROM user_deposit WHERE status IN ('1', '9') AND client_pay_method = '1' AND (STR_TO_DATE(created, '%Y-%m-%d') BETWEEN DATE_SUB(NOW(), INTERVAL 1 WEEK) AND DATE_SUB(NOW(), INTERVAL 10 MINUTE))";
