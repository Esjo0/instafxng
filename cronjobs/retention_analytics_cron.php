...
$db_handle->runQuery("CREATE TEMPORARY TABLE my_reference_clients_3 AS " . $base_query);
...
$db_handle->runQuery("CREATE TEMPORARY TABLE my_reference_clients_4 AS " . $base_query2);
