            ...
            <div class="row no-gutter">
                ...
                <div id="main-body-content-area" class="col-md-8 col-md-push-4 col-lg-9 col-lg-push-3 ">
                    ...
                    <div  class="item super-shadow home-page-top-section">
                        <div class="row">
                            <div class="col-md-12">
                                <img data-target="#contest-register" data-toggle="modal" id="img_div_2" width="100%" class="img img-responsive" src="https://instafxng.com/imgsource/independence_winner_3.jpg" style="height:300px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)">
                            </div>
                        </div>
                       </div>
