            ...
            <div class="row wow fadeIn">
                ...
                <div class="col-md-12 mb-4 white-text text-center">
                    <a href="https//:instafxng.com">
                        <center><img style="background-image: url('img/gilt.jpg'); border-radius: 10px;"
                                     src="../images/ifxlogo.png" class="img-fluid z-depth-1-half img-responsive"
                                     alt=""/>
                            <center>
                    </a>
                    <hr class="hr-light">
                            ...
                            <div class="card-body">
                                <p class="text-center"
                                   style="font-family: cursive !important; border-radius:5px; background-color: rgba(255, 194, 36, 0.29); color: black;">
                                    <b>YOUR SEAT HAS BEEN RESERVED TEMPORARILY CONFIRM YOUR RESERVATION WITHIN THE NEXT
                                        5 DAYS.</b></p>
                            </div>
                        </div>
                    <?php } ?>
                    <?php if ($choice == 3) { ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-center"
                                   style="font-family: cursive !important; border-radius:5px; background-color: rgba(255, 194, 36, 0.29); color: black;">
                                    <b>THANKS YOU WE WILL SURELY INVITE YOU FOR SUBSEQUENT EVENTS.</b></p>
                            </div>
                        </div>
                    <?php } ?>
