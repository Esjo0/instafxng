...
if (isset($_POST['submit'])) {
	...
	if(empty($full_name) || empty($email_address) || empty($phone_number)) {
		...
		if($result) {
			...
			redirect_to('../forex-income/thank_you.php');
		} else {
		...
		<div class="header fixed-top">
				<nav class="navbar navbar-default link-effect-8" id="link-effect-8">
							...
							<div class="top-nav-text">
								<div class="nav-contact-w3ls"><i class="glyphicon glyphicon-phone-alt" aria-hidden="true"></i>   <p style="color: #000000"><b>   +(234) 080 262 399</b></p></div>
							</div>
							<!-- navbar-header -->
							...
							<div class="container">
								<div class="slider-info">
									<div class="col-md-7  slider-info-txt">
										<h2 >Sit at the comfort of your home or office and make over $20 daily!</h2>
