...
if(!empty($_GET['ft'])){
    ...
    $all_referrals = $partner_object->filter_referrals($user_code, $_GET['ft']);
...
<html lang="en">
    <head>
        ...
        <title>Instafxng Partner | Filter</title>
        <meta name="title" content="Instafxng Partner | Filter" />
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div>
                                    ...
                                    <form method="get" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data" style="display: inline-block;">
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Email</th>
                                            <!--<th>Phone</th>-->
                                            <th>Commission On Deposit</th>
                                            <th>Commission On Withdrawals</th>
                                            <th>Financial Commission (Deposit + Withdrawal)</th>
                                            <th>Commission On Trading</th>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $all_referrals[$i]['deposit_commissions']; ?></td>
                                            <td><?php echo $all_referrals[$i]['withdrawal_commissions']; ?></td>
                                            <td><?php echo $all_referrals[$i]['financial_commissions']; ?></td>
