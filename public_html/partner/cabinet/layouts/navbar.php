    ...
    <div  class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="partner/cabinet/my_profile.php" title="My Profile"> My Profile</a></li>
                    <li><a href="partner/cabinet/bank_view.php" title="Bank Account"> Bank Account</a></li>
                    <li><a href="partner/cabinet/verification.php" title="Verification"> Verification</a></li>
                </ul>
            </li>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li><a href="partner/cabinet/logout.php" title="Logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a></li>
        </ul>
    </div>
</nav>