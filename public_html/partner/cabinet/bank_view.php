...
<head>
    ...
    <title>Instaforex Nigeria | View Bank Accounts</title>
    <meta name="title" content="Instaforex Nigeria | View Bank Accounts" />
            ...
            <div class="section-tint super-shadow">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>Here is the list bank accounts that you have added to the system.</p>
                    </div>
                </div>
                <div class="row">
