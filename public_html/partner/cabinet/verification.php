...
<head>
    ...
    <title>Instaforex Nigeria | Partner Verification</title>
    <meta name="title" content="Instaforex Nigeria | Partner Verification" />
            ...
            <div class="section-tint super-shadow">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>Verification is required for you to be able to make cashout from your earnings.</p>
                    </div>
                </div>
                <div class="row">
