...
$upload_dir = '/imgsource/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../imgsource/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../imgthumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
