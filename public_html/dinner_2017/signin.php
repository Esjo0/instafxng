    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title">The Ethinc Impression 2017</h4></center>
            </div>
            <div class="modal-body">
                <?php require_once '../layouts/feedback_message.php'; ?>
                <p><b>Update Your Reservation</b></p>
                <p>Enter your email address and click the button below to proceed.</p>
