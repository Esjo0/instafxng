            ...
            if ($db_handle->numRows($query) > 0) {
                ...
                if (!empty($user_details)) {
                    foreach ($user_details AS $row) {
                        extract($row);
                        $signal_object->add_lead($name, $email, $phone, 1, $interest, $date);
                    ...
                    $message_error = "Please update your profile details.This";
                    $get_phone_and_name = true;
                }
            }
        } else {
            ...
            <div class="col-12 my-auto">
                <div class="masthead-content text-white py-5 py-md-0">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group">
                        <label><input type="radio" name="interest" value="1"><b>I trade with Instaforex.</b></label>
                            <label><input type="radio" name="interest" value="2"><b>I trade with Other brokers.</b></label><br/>
                            <label><input type="radio" name="interest" value="3"><b>I trade Not Traded Forex Before.</b></label>
                            </div>
                    <?php } ?>
                    </form>
                </div>
...
<div class="social-icons">
    <ul class="list-unstyled text-center mb-0">
        <li class="list-unstyled-item" style="background-color: rgba(202, 45, 37, 0.73)">
            <a href="#">
