        ...
        <div class="row h-100">
            <div class="col-12 my-auto">
                <div class="masthead-content text-white py-5 py-md-0">
                    ...
                    <p class="mb-2 text-center"><b> Thank you for Subscribing to our signals. You are now to eligible to view our signals page.
                            <br>
                            <img src="../images/Spinner.gif">
                            <br>
                            You will be redirected to the page shortly. or you can click <a href="https://instafxng.com/signal_schedules.php">here</a> to view signals now.</p>
...
<script src="../js/fxsignals.min.js"></script>
                    <script>
                        ...
                        setTimeout(function () {
                            ...
                            window.location.href= 'https://instafxng.com/signal_schedules.php';
                        }, 10000);
                    </script>
