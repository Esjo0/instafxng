...
$query = "SELECT phone, name, email, created FROM signal_users ORDER BY created DESC";
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>TRADING SIGNAL USERS</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        ...
                        <?php if(isset($all_users) && !empty($all_users)) { require_once 'layouts/pagination_links.php'; } ?>
                    </div>
