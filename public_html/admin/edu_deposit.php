...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - Deposits for Education</title>
        <meta name="title" content="Instaforex Nigeria | Admin - Deposits for Education" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>DEPOSITS - EDUCATION</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>See education deposits below, click to process each deposit order.</p>
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <?php if(isset($education_deposit) && !empty($education_deposit)) { foreach ($education_deposit as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a title="View" class="btn btn-info" href="edu_deposit_process.php?id=<?php echo dec_enc('encrypt', $row['trans_id']); ?>"><i class="glyphicon glyphicon-eye-open icon-white"></i> </a>
                                            </td>
                                        </tr>
