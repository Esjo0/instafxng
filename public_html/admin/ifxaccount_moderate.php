                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a  title="Edit" class="btn btn-info" href="client_moderate_process.php?x=edit&id=<?php echo dec_enc('encrypt', $row['ifxaccount_id']); ?>"><i class="glyphicon glyphicon-edit icon-white"></i> </a>
                                            </td>
                                        </tr>
