...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
    ...
    $query = "SELECT u.user_code, CONCAT(u.last_name, SPACE(1), u.first_name) AS full_name, u.email, u.phone,
          u.academy_signup, CONCAT(a.last_name, SPACE(1), a.first_name) AS account_officer_full_name, ftc.entry_point
...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - All Category 2 Students</title>
        <meta name="title" content="Instaforex Nigeria | Admin - All Category 2 Students" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>STUDENTS - Category 2</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p class="pull-left">List of students that have already started taking lessons in course 1.<br/>
                                            This category includes anyone in lessons 1-4.</p>
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <?php if(isset($education_students) && !empty($education_students)) { foreach ($education_students as $row) { ?>
                                        <tr>
                                            ...
                                            <td nowrap="nowrap">
                                                <a title="Comment" class="btn btn-success" href="sales_contact_view.php?x=<?php echo dec_enc('encrypt', $row['user_code']); ?>&r=<?php echo 'edu_student_category_2'; ?>&c=<?php echo dec_enc('encrypt', 'STUDENT CATEGORY 2'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
