...
if(isset($_POST['search'])){
    ...
    $query = "SELECT facility_inventory.invent_id AS inventoryid,
          ...
          facility_location.location AS location
           ...
           WHERE  facility_inventory.location = accounting_system_office_locations.location_id 
        ...
        <div id="main-body-content-area" class="col-md-8 col-lg-9">
            ...
            <div class="row">
                <div class="col-sm-12 text-danger">
                    <a class="btn btn-sm btn-default" href="facility_manager.php"><i class="fa fa-mail-reply fa-fw"></i>Back</a>
                    <h4> <strong>FACILITY EQUIPMENT</strong></h4>
                </div>
            </div>
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <td><?php echo $row['cart'];?></td>
                                    <td><div class="form-group">
                                            <button type="button" data-target="#completel<?php echo $row['inventoryid'];?>" data-toggle="modal" class="btn btn-success"><i class="fa fa-history fa-fw"></i></button>
                                            <button type="button" data-target="#assignl<?php echo $row['inventoryid'];?>" data-toggle="modal" class="btn btn-success">Assign</button>
                                        </div>
                                    <!--Modal - confirmation boxes-->
                                    <div id="completel<?php echo $row['inventoryid'];?>" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" data-dismiss="modal" aria-hidden="true"
                                        ...
                                        <!--Modal - confirmation boxes-->
                                        <div id="assignl<?php echo $row['inventoryid'];?>" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" data-dismiss="modal" aria-hidden="true"
