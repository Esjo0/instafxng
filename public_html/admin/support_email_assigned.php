                                    ...
                                    <?php if(isset($all_emails) && !empty($all_emails)) {
                                        foreach ($all_emails as $row) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="support_email_view.php?id=<?php echo encrypt($row['email_id']); ?>&type=<?php echo encrypt('assigned'); ?>"><button class="btn btn-success"><i class="glyphicon glyphicon-arrow-right"></i></button></a>
                                                </td>
                                            </tr>
