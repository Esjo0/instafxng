...
$sum_query = "SELECT SUM(ud.dollar_ordered) AS sum_dollar_ordered, SUM(ud.naira_total_payable) AS sum_naira_total_payable
        ...
        WHERE ud.status = '2' OR ud.status = '3' ORDER BY ud.client_notified_date DESC ";
...
$notified_deposit_requests = $db_handle->fetchAssoc($result);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Instaforex Nigeria | Admin - Notified Deposit</title>
    <meta name="title" content="Instaforex Nigeria | Admin - Notified Deposit" />
        ...
        <div id="main-body-content-area" class="col-md-8 col-lg-9">
            ...
            <div class="row">
                <div class="col-sm-12 text-danger">
                    <h4><strong>NOTIFIED DEPOSIT</strong></h4>
                </div>
            </div>
            ...
            <div class="section-tint super-shadow">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>Below is the list of all deposit requests that have notified.</p>
                        ...
                        <div class="row">
                            ...
                            <?php if(isset($notified_deposit_requests) && !empty($notified_deposit_requests)) {
                                foreach ($notified_deposit_requests as $row) { ?>
                                    <!-- Order -->
                                    <div class="col-sm-6">
                                        <div class="trans_item">
                                            <div class="trans_item_content">
                                                ...
                                                <div class="row" style="margin-top: 5px;">
                                                    ...
                                                    <div class="col-xs-4"><span style="text-align: right"><a class="btn btn-info" href="deposit_process.php?x=notified&id=<?php echo dec_enc('encrypt', $row['trans_id']); ?>"><i class="glyphicon glyphicon-edit icon-white"></i> Process</a></span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <?php } ?>
                <?php if(isset($notified_deposit_requests) && !empty($notified_deposit_requests)) { require_once 'layouts/pagination_links.php'; } ?>
            </div>
