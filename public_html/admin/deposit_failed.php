...
$pay_method = decrypt_ssl(str_replace(" ", "+", $pay_method_encrypted));
                                    ...
                                    if(isset($failed_deposit_requests) && !empty($failed_deposit_requests)) {
                                        foreach ($failed_deposit_requests as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="nowrap">
                                                    <a title="Comment" class="btn btn-success" href="deposit_failed_comment.php?x=<?php echo encrypt_ssl($row['trans_id']); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
                                                    <a target="_blank" title="View" class="btn btn-info" href="deposit_search_view.php?id=<?php echo encrypt_ssl($row['trans_id']); ?>"><i class="glyphicon glyphicon-eye-open icon-white"></i> </a>

                                                    <?php if($allowed_requery_button) { ?>
                                                    <a title="Re-Query" class="btn btn-default" href="deposit_failed.php?id=<?php echo encrypt_ssl($row['trans_id']); ?>&pm=<?php echo encrypt_ssl($row['client_pay_method']); ?>"><i class="fa fa-question icon-white"></i> </a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
