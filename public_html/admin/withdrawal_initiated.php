                                        ...
                                        <div class="trans_item">
                                            <div class="trans_item_content">
                                                ...
                                                <div class="row" style="margin-top: 5px;">
                                                    ...
                                                    <div class="col-xs-4"><span style="text-align: right"><a class="btn btn-info" href="withdraw_process.php?x=initiated&id=<?php echo encrypt_ssl($row['trans_id']); ?>"><i class="glyphicon glyphicon-edit icon-white"></i> Process</a></span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
