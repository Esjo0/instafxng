...
if(isset($_POST['reviewed'])){
    ...
    $remark = $db_handle->sanitizePost($_POST['remark']);
    $result = $bonus_operations->successful_bonus($_SESSION['admin_unique_code'], $remark, $bonus_account_id);
    $result ? $message_success = "Operation Successful" : $message_warning = "Operation Failed: Please review this bonus profile afresh.";
}
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p class="pull-left"><a href="bonus_successful_accounts.php" class="btn btn-default" title="Bonus Accounts"><i class="fa fa-arrow-circle-left"></i> Bonus Accounts</a></p>
                                        <?php if($app_details['bonus_status'] == '1'){?>
                                        <p class="pull-right"><button data-toggle="modal" data-target="#app_approve" class="btn btn-sm btn-success" title=""><b style="font-size: medium"><i class="fa fa-check"></i> Bonus Cycle Completed</b></button></p>
                                        <?php } ?>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Recycle Bonus Account</h4></div>
                                                <div class="modal-body">
                                                    This Bonus Account has met all the Terms and conditions of its selected bonus package.
                                                    It is due for release and recycling.
                                                    Click the Proceed button below to recycle this account.
