...
$all_deleted_clients = $db_handle->fetchAssoc($result);
...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - Deleted Client List</title>
        <meta name="title" content="Instaforex Nigeria | Admin - Deleted Client List" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>DELETED CLIENT LIST</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>Below is a table of all clients that have been deleted from the system.</p>
                                ...
                                <div class="table-wrap">
                                    <table class="table table-responsive table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php if(isset($all_deleted_clients) && !empty($all_deleted_clients)) { foreach ($all_deleted_clients as $row) { ?>
                                            <tr>
                                ...
                                <?php if(isset($all_deleted_clients) && !empty($all_deleted_clients)) { ?>
                        ...
                        <?php if(isset($all_deleted_clients) && !empty($all_deleted_clients)) { require_once 'layouts/pagination_links.php'; } ?>
