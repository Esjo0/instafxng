...
$upload_dir = '/images/education/main/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../images/education/main/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../images/education/thumb/'; // relative path from filemanager folder to thumbs folder (with final /)
