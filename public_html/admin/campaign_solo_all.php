                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="nowrap">
                                                <a title="Edit" class="btn btn-default" href="campaign_solo_view.php?x=edit&id=<?php echo encrypt_ssl($row['campaign_email_solo_id']); ?>"><i class="glyphicon glyphicon-edit icon-white"></i> </a>
                                            </td>
                                        </tr>
