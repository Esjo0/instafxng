            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (in_array(248, $my_pages_sidebar)) { ?><li><a href="operations_log.php" title="Moderate Bank Account">Operations Log</a></li><?php } ?>
                        <?php if (in_array(249, $my_pages_sidebar)) { ?><li><a href="operations_log_report.php" title="Moderate Bank Account">Operations Log Report</a></li><?php } ?>
                    </ul>
                </li>
