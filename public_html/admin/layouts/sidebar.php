            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="accounting_system_req_reports.php" title="Requisition Report">Requisition Report</a></li>
                        <li><a href="accounting_system_settings.php" title="Requisition Report">System Settings</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (in_array(50, $my_pages_sidebar)) { ?><li><a href="independence_quiz_results.php" title="Independence Quiz Results">2017 Independence Quiz Results</a></li><?php } ?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (in_array(203, $my_pages_sidebar)) { ?><li><a href="project_management_all_projects.php" title="All Projects">All Projects</a></li><?php } ?>
