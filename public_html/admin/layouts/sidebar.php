            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (in_array("32b", $my_pages_sidebar)) { ?><li><a href="deposit_confirmed_view_only.php" title="Confirmed Deposit (View Only)">Deposit - Confirmed (View Only)</a></li><?php } ?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (in_array("42b", $my_pages_sidebar)) { ?><li><a href="withdrawal_confirmed_view_only.php" title="Confirmed Withdrawal (View Only)">Withdrawal - Confirmed (View Only)</a></li><?php } ?>
