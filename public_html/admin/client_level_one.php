...
$selected_lev1_clients = $db_handle->fetchAssoc($result);
...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - Level One Clients</title>
        <meta name="title" content="Instaforex Nigeria | Admin - Level One Clients" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>LEVEL ONE CLIENTS</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>Below are clients that have passed the Level 1 Verification Stage, this means that their emails and phone numbers
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    if(isset($selected_lev1_clients) && !empty($selected_lev1_clients)) { foreach ($selected_lev1_clients as $row) {
                                        ?>
                                        <tr>
                                            ...
                                            <td nowrap="nowrap">
                                                <a title="Comment" class="btn btn-success" href="sales_contact_view.php?x=<?php echo dec_enc('encrypt', $row['user_code']); ?>&r=<?php echo 'client_level_one'; ?>&c=<?php echo dec_enc('encrypt', 'LEVEL ONE CLIENT'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
                                ...
                                <?php if(isset($selected_lev1_clients) && !empty($selected_lev1_clients)) { ?>
