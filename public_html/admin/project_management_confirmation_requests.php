                            ...
                            <?php if(isset($projects) && !empty($projects))
                            {
                                ...
                                { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="project_management_report_view.php?x=<?php echo encrypt($row['report_code']); ?>"><button class="btn btn-success"><i class="glyphicon glyphicon-eye-open"></i></button></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
