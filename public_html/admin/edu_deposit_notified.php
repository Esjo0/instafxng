...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
    ...
    $query = "SELECT ued.status, ued.amount, ued.stamp_duty, ued.gateway_charge,
            ...
            WHERE ued.status = '2' OR ued.status = '6' AND (ued.trans_id LIKE '%$search_text%' OR u.email LIKE '%$search_text%' OR u.first_name LIKE '%$search_text%' OR u.middle_name LIKE '%$search_text%' OR u.last_name LIKE '%$search_text%' OR u.phone LIKE '%$search_text%' OR u.created LIKE '$search_text%')
...
<head>
    ...
    <title>Instaforex Nigeria | Admin - Education Deposit Notified</title>
    <meta name="title" content="Instaforex Nigeria | Admin - Education Deposit Notified" />
        ...
        <div id="main-body-content-area" class="col-md-8 col-lg-9">
            ...
            <div class="row">
                <div class="col-sm-12 text-danger">
                    <h4><strong>EDUCATION - DEPOSIT NOTIFIED</strong></h4>
                </div>
            </div>
            ...
            <div class="section-tint super-shadow">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>See notified education deposits below, click to process each deposit order.</p>
                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover">
                            ...
                            <?php if(isset($education_deposit) && !empty($education_deposit)) { foreach ($education_deposit as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a title="View" class="btn btn-info" href="edu_deposit_process.php?x=notified&id=<?php echo dec_enc('encrypt', $row['trans_id']); ?>"><i class="glyphicon glyphicon-eye-open icon-white"></i> </a>
                                    </td>
                                </tr>
