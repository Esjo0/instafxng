            ...
            <div class="section-tint super-shadow">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>The list of clients that produced between $300 and $499 commission and above between December 1, 2017 to November 30, 2018</p>
                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover">
                            ...
                            if(isset($selected_silver_comm_clients) && !empty($selected_silver_comm_clients)) { foreach ($selected_silver_comm_clients as $row) {
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <a title="Comment" class="btn btn-success" href="sales_contact_view.php?x=<?php echo dec_enc('encrypt', $row['user_code']); ?>&r=<?php echo 'client_comm_silver'; ?>&c=<?php echo dec_enc('encrypt', 'SILVER COMMISSION CLIENTS'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
