...
if (isset($_POST["upload_points"])) {
    ...
    if(black_friday_duplicate($point_date)) {
        ...
        foreach ($fetched_data AS $value) {
            ...
            $query = "SELECT SUM(point_earned) AS my_points FROM point_based_reward WHERE user_code = '$my_user_code' AND date_earned = '$point_date' GROUP BY user_code";
            $result = $db_handle->runQuery($query);
            $fetched_data = $db_handle->fetchAssoc($result);
            ...
            // UPDATE THE POINTS
            $query = "UPDATE black_friday_2018 SET total_points = total_points + $my_points WHERE user_code = '$my_user_code' LIMIT 1";
            $result = $db_handle->runQuery($query);
        }
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>GENERATE BLACK FRIDAY POINTS</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>Choose a date below to generate points for the Black friday Table.</p>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Generate Black Friday Point Confirmation</h4>
                                                </div>
