                                ...
                                <div class="col-md-12 order-md-1">
                                    <form class="needs-validation" role="form" method="post" action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-5">
                                                <div class="input-group date">
                                                    <select id="options" class="form-control" onchange="displayOptions()">
                                                        <option value=""></option>
                                        ...
                                        <br/>
                                        <hr/>
                                        <div class="form-group" style="display:none;" id="buy">
                                            <div class="col-sm-12">
                                                <div class="row">
...
<br/>
                                        <div class="form-group" style="display:none;" id="sell">
