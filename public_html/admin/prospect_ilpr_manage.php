                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(isset($all_prospect) && !empty($all_prospect)) {
                                        foreach ($all_prospect as $row) {
                                            $fullname = $row['f_name']." ".$row['m_name']." ".strtoupper($row['l_name']) ?>
                                            <tr>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="tab-content">
                                                                        ...
                                                                        <div id="successfull" class="tab-pane fade">
                                                                            <form data-toggle="validator" class="form-horizontal" role="form" method="post" action="">
                                                                            <p>You have <strong>successfully</strong> contacted <?php echo $fullname; ?>.</p>
                                                                                <h3>Open ILPR Account</h3>
                                                                                ...
                                                                                <form data-toggle="validator" class="form-horizontal" role="form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-sm-9 col-lg-5">
                                                                                            <input name="full_name" type="text" class="form-control" id="full_name" value="<?php echo $fullname; ?>" required>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group">
