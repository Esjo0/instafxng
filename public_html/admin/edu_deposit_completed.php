...
<head>
    ...
    <title>Instaforex Nigeria | Admin - Education Deposit Completed</title>
    <meta name="title" content="Instaforex Nigeria | Admin - Education Deposit Completed" />
            ...
            <div class="section-tint super-shadow">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>See completed education deposits below, click to process each deposit order.</p>
                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover">
                            ...
                            <?php if(isset($education_deposit) && !empty($education_deposit)) { foreach ($education_deposit as $row) {
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-info" href="edu_deposit_process.php?x=completed&id=<?php echo dec_enc('encrypt', $row['trans_id']); ?>" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                </tr>
