                                    ...
                                    if(isset($withdrawal_insight) && !empty($withdrawal_insight)) {
                                        foreach ($withdrawal_insight as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap="nowrap">
                                                    <a title="View" class="btn btn-success" href="client_reach.php?x=<?php echo dec_enc('encrypt', $row['user_code']); ?>&r=<?php echo 'insight/last_month_withdrawal'; ?>&c=<?php echo dec_enc('encrypt', 'LAST MONTH WITHDRAWAL'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i></a>
