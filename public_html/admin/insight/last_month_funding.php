...
$funding_insight = $db_handle->fetchAssoc($result);
...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Funding Insight</title>
        <meta name="title" content="Instaforex Nigeria | Funding Insight" />
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    if(isset($funding_insight) && !empty($funding_insight)) {
                                        foreach ($funding_insight as $row) {
                                            ?>
                                            <tr>
                                                ...
                                                <td nowrap="nowrap">
                                                    <a title="View" class="btn btn-success" href="client_reach.php?x=<?php echo dec_enc('encrypt', $row['user_code']); ?>&r=<?php echo 'insight/last_month_funding'; ?>&c=<?php echo dec_enc('encrypt', 'LAST MONTH FUNDING'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i></a>
                                ...
                                <?php if(isset($funding_insight) && !empty($funding_insight)) { ?>
