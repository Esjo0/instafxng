                                    ...
                                    if(isset($funding_insight) && !empty($funding_insight)) {
                                        foreach ($funding_insight as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap="nowrap">
                                                    <a title="View" class="btn btn-success" href="client_reach.php?x=<?php echo encrypt_ssl($row['user_code']); ?>&r=<?php echo 'insight/last_month_funding'; ?>&c=<?php echo encrypt_ssl('LAST MONTH FUNDING'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i></a>
