                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <p><a href="edu_course_new.php?x=edit&id=<?php echo dec_enc('encrypt', $course_id); ?>" class="btn btn-default" title="Edit Course"><i class="fa fa-edit"></i> Edit Course</a></p>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <p class="text-right"><a href="edu_lesson_new.php?cid=<?php echo dec_enc('encrypt', $course_id); ?>" class="btn btn-default" title="Create new lesson for this course">Create New Lesson <i class="fa fa-arrow-circle-right"></i></a></p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                                                <li role="presentation"><a role="menuitem" tabindex="-1" title="View Lesson Details" href="edu_lesson_view.php?cid=<?php echo dec_enc('encrypt', $course_id); ?>&lid=<?php echo dec_enc('encrypt', $row['edu_lesson_id']); ?>"><i class="fa fa-eye fa-fw"></i> View Lesson</a></li>
                                                                <li role="presentation"><a role="menuitem" tabindex="-1" title="Edit Lesson" href="edu_lesson_new.php?cid=<?php echo dec_enc('encrypt', $course_id); ?>&x=edit&lid=<?php echo dec_enc('encrypt', $row['edu_lesson_id']); ?>"><i class="fa fa-edit fa-fw"></i> Edit Lesson</a></li>
                                                                <li role="presentation"><a role="menuitem" tabindex="-1" title="Create Exercise" href="edu_exercise_new.php?cid=<?php echo dec_enc('encrypt', $course_id); ?>&lid=<?php echo dec_enc('encrypt', $row['edu_lesson_id']); ?>"><i class="fa fa-question-circle fa-fw"></i> Create Exercise</a></li>
