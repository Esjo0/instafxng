...
<head>
    ...
    <title>Instaforex Nigeria | Admin - Education Deposit Declined</title>
    <meta name="title" content="Instaforex Nigeria | Admin - Education Deposit Declined" />
        ...
        <div id="main-body-content-area" class="col-md-8 col-lg-9">
            ...
            <div class="row">
                <div class="col-sm-12 text-danger">
                    <h4><strong>EDUCATION - DEPOSIT DECLINED</strong></h4>
                </div>
            </div>
            ...
            <div class="section-tint super-shadow">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>See declined education deposits below, click to process each deposit order.</p>
