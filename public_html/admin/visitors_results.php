                            ...
                            <?php if(isset($all_comments_items) && !empty($all_comments_items))
                            {
                                ...
                                { ?>
                                    <tr>
                                        ...
                                        <td><a href="campaign_email_single.php?name=<?php echo dec_enc('encrypt', $row['visitor_name']).'&email='.dec_enc('encrypt', $row['visitor_email']);?>" ><button name="send_email" class="btn btn-success glyphicon glyphicon-envelope"></button></a></td>
                                    </tr>
                                    <?php
                                }
                            }
