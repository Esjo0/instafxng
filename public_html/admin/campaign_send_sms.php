                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 col-lg-6">
                                            <select name="category" class="form-control" id="category">
                                                ...
                                                <option value="<?php echo $row['campaign_category_id']; ?>"><?php echo $row['title']; ?></option>
                                                <?php } } ?>
                                            </select>
                                        </div>
                                    </div>
