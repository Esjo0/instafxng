                                        ...
                                        <table class="table table-responsive table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="deposit_process_view_only.php?x=confirmed&id=<?php echo dec_enc('encrypt', $row['trans_id']) ?>" target="_blank" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-info-sign"></i></a>
