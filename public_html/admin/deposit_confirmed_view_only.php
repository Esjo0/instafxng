...
/*                                                        if(!empty($row['passport'])) { $file_location = "../userfiles/" . $row['passport']; }
                                    ...
                                    <!-- close -->
                                            <div class="col-sm-12">
                                                <table class="table table-responsive table-striped table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button data-target="#client_profile(<?php $row['user_code'];?>)" data-toggle="modal" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-user"></i></button>
                                                            <button data-target="#transaction_info(<?php $row['trans_id'];?>)" data-toggle="modal" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-info-sign"></i></button>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div id="transaction_info(<?php $row['trans_id'];?>)" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
                                            ...
                                            <div id="client_profile(<?php $row['user_code'];?>)" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
