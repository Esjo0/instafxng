...
$selected_ilpr_clients = $db_handle->fetchAssoc($result);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - ILPR Clients</title>
        <meta name="title" content="Instaforex Nigeria | Admin - ILPR Clients" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>ILPR CLIENTS</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>Below is a table of ILPR clients. These clients opened their Instaforex
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    if(isset($selected_ilpr_clients) && !empty($selected_ilpr_clients)) { foreach ($selected_ilpr_clients as $row) {
                                        ?>
                                        <tr>
                                ...
                                <?php if(isset($selected_ilpr_clients) && !empty($selected_ilpr_clients)) { ?>
                        ...
                        <?php if(isset($selected_ilpr_clients) && !empty($selected_ilpr_clients)) { require_once 'layouts/pagination_links.php'; } ?>
                    </div>
