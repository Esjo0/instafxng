        ...
        switch ($filter)
        {
            ...
            case 2:
                $query = "SELECT DISTINCT user.user_code, user.first_name, user.email, user.phone 
                          ...
                          GROUP BY user.phone";
                $dispaly_msg = "Details of unique clients that joined the system last month New Clients without Accounts and have no Training.";
                break;
            case 3:
                                ...
                                <form data-toggle="validator" class="form-horizontal" role="form" method="post" action="">
                                    <div class="col-sm-4">
                                        <select name="filter" class="form-control" id="filter" onchange="myFunction()">
                                            <option <?php if($filter == 1){echo "selected";} ?> value="1">Last Months New Clients with Accounts</option>
                                            <option <?php if($filter == 2){echo "selected";} ?> value="2">Last Months New Clients without Accounts and have no Training</option>
                                            <option <?php if($filter == 3){echo "selected";} ?> value="3">Last Months New Clients without Accounts and have Training</option>
                                            <option <?php if($filter == 4){echo "selected";} ?> value="4">Last Months New Trainee Still in course 2 in current month</option>
                                            <option <?php if($filter == 5){echo "selected";} ?> value="5">Last Months New Clients not yet funded above $50</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-8">
