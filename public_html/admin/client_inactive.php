                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    if(isset($selected_inactive_clients) && !empty($selected_inactive_clients)) { foreach ($selected_inactive_clients as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td nowrap="nowrap">
                                                <a title="Comment" class="btn btn-xs btn-success" href="sales_contact_view.php?x=<?php echo encrypt_ssl($row['user_code']); ?>&r=<?php echo 'client_inactive'; ?>&c=<?php echo encrypt_ssl('INACTIVE TRADING CLIENT'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
