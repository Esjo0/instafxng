...
if (isset($_POST['active_trading_client']) || isset($_GET['pg'])) {

    if(isset($_POST['active_trading_client'])) {
    ...
    $selected_active_clients = $db_handle->fetchAssoc($result);
}
...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - Active Trading Clients</title>
        <meta name="title" content="Instaforex Nigeria | Admin - Active Trading Clients" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>ACTIVE TRADING CLIENTS</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>Pick a date range below to see <strong>Active Trading Clients</strong>. If you want to search for
                                ...
                                <form data-toggle="validator" class="form-horizontal" role="form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9"><input name="active_trading_client" type="submit" class="btn btn-success" value="Display" /></div>
                                    </div>
                                ...
                                <?php if(isset($selected_active_clients) && !empty($selected_active_clients)) { require 'layouts/pagination_links.php'; } ?>
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    if(isset($selected_active_clients) && !empty($selected_active_clients)) { foreach ($selected_active_clients as $row) {
                                        ?>
                                        <tr>
                                            ...
                                            <td nowrap="nowrap">
                                                <a title="Comment" class="btn btn-success" href="sales_contact_view.php?x=<?php echo dec_enc('encrypt', $row['user_code']); ?>&r=<?php echo 'client_active'; ?>&c=<?php echo dec_enc('encrypt', 'ACTIVE TRADING CLIENT'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
                                ...
                                <?php if(isset($selected_active_clients) && !empty($selected_active_clients)) { ?>
