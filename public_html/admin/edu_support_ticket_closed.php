                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <?php if(isset($education_tickets) && !empty($education_tickets)) { foreach ($education_tickets as $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank" title="View" class="btn btn-info" href="edu_support_ticket_view.php?id=<?php echo encrypt_ssl($row['support_request_code']); ?>"><i class="glyphicon glyphicon-eye-open icon-white"></i> </a>
                                            </td>
                                        </tr>
