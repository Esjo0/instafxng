...
$selected_bronze_comm_clients = $db_handle->fetchAssoc($result);
...
<head>
    ...
    <title>Instaforex Nigeria | Admin - Bronze Commission Clients</title>
    <meta name="title" content="Instaforex Nigeria | Admin - Bronze Commission Clients" />
        ...
        <div id="main-body-content-area" class="col-md-8 col-lg-9">
            ...
            <div class="row">
                <div class="col-sm-12 text-danger">
                    <h4><strong>BRONZE COMMISSION CLIENTS</strong></h4>
                </div>
            </div>
            ...
            <div class="section-tint super-shadow">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php if(isset($selected_bronze_comm_clients) && !empty($selected_bronze_comm_clients)) { require 'layouts/pagination_links.php'; } ?>
                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php
                            if(isset($selected_bronze_comm_clients) && !empty($selected_bronze_comm_clients)) { foreach ($selected_bronze_comm_clients as $row) {
                                ?>
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <a title="Comment" class="btn btn-success" href="sales_contact_view.php?x=<?php echo dec_enc('encrypt', $row['user_code']); ?>&r=<?php echo 'client_comm_bronze'; ?>&c=<?php echo encrypt_ssl('BRONZE COMMISSION CLIENTS'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
                        ...
                        <?php if(isset($selected_bronze_comm_clients) && !empty($selected_bronze_comm_clients)) { ?>
