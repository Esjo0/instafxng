...
$query = "SELECT SUM(views) AS Total FROM signal_daily";
                            ...
                            <ul class="list-group mb-3">
                                ...
                                <li class="list-group-item d-flex justify-content-between lh-condensed" data-toggle="modal" data-target="#editsignal<?php echo $row['signal_id']?>">
                                    ...
                                    <span class="text-muted">
                                        PRICE: <?php echo $row['price'];?> <?php if($row['order_type'] == 2){echo" <b class='text-danger'><i class='glyphicon glyphicon-arrow-down'></i></b>";}
										elseif($row['order_type'] == 1){echo"<b class='text-success'><i class='glyphicon glyphicon-arrow-up'></i></b>";}?>
          <button class="btn btn-default pull-right"><i class="fa fa-eye fa-fw"></i> <?php echo $row['views']?></button></span>
                                    </li>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">This Trade is to trigger By <?php echo datetime_to_text($row['trigger_date']." ".$row['trigger_time']);?> </h5>
...
<script>
    function displayOptions() {
        ...
        console.log(options);
        if(options == 1){document.getElementById("buy").style.display = "block";
        ...
        else if(options == 2){document.getElementById("sell").style.display = "block";
        ...
        else if(options == 3){document.getElementById("buy").style.display = "block";
            document.getElementById("sell").style.display = "block";}
            else{document.getElementById("buy").style.display = "none";
            document.getElementById("sell").style.display = "none";}
    }
</script>
