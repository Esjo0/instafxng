                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p class="pull-left">List of students that have reached lesson 5 of course 1.</p>
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <?php if(isset($education_students) && !empty($education_students)) { foreach ($education_students as $row) { ?>
                                        <tr>
                                            ...
                                            <td nowrap="nowrap">
                                                <a title="Comment" class="btn btn-xs btn-success" href="sales_contact_view.php?x=<?php echo dec_enc('encrypt', $row['user_code']); ?>&r=<?php echo 'edu_student_category_3'; ?>&c=<?php echo dec_enc('encrypt', 'STUDENT CATEGORY 3'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
