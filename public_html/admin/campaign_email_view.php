                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="nowrap">
                                                ...
                                                <a title="Edit" class="btn btn-default" href="campaign_email.php?x=edit&id=<?php echo encrypt($row['campaign_id']); ?>"><i class="glyphicon glyphicon-edit icon-white"></i> </a>
                                                <?php } ?>
                                                
                                                <a title="Send Test" class="btn btn-info" href="campaign_email_broadcast.php?x=test&id=<?php echo encrypt($row['campaign_id']); ?>"><i class="fa fa-paper-plane fa-fw"></i> </a>
                                                
                                                <?php if($row['campaign_status'] == '2' && $row['campaign_send_status'] == '2') { ?>
                                                <a title="Broadcast" class="btn btn-success" href="campaign_email_broadcast.php?x=send&id=<?php echo encrypt($row['campaign_id']); ?>"><i class="fa fa-bullhorn fa-fw"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
