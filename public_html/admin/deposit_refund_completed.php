...
$deposit_refund_completed = $db_handle->fetchAssoc($result);
...
<head>
    ...
    <title>Instaforex Nigeria | Admin - Deposit Refund Completed</title>
    <meta name="title" content="Instaforex Nigeria | Admin - Deposit Refund Completed" />
    ...
    <div class="row no-gutter">
        ...
        <div id="main-body-content-area" class="col-md-8 col-lg-9">
            ...
            <div class="section-tint super-shadow">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php
                            if(isset($deposit_refund_completed) && !empty($deposit_refund_completed)) {
                                foreach ($deposit_refund_completed as $row) {
                                    ?>
                                    <tr>
                        ...
                        <?php if(isset($deposit_refund_completed) && !empty($deposit_refund_completed)) { ?>
                ...
                <?php if(isset($deposit_refund_completed) && !empty($deposit_refund_completed)) { require_once 'layouts/pagination_links.php'; } ?>
            </div>
