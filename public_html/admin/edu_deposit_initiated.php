                                                ...
                                                <table class="table table-responsive">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="nowrap">
                                                                <a class="btn btn-info" href="edu_deposit_pay_notify.php?x=initiated&id=<?php echo dec_enc('encrypt', $data['trans_id']); ?>" title="Payment Notification"><i class="fa fa-bell-o" aria-hidden="true"></i></a>
                                                                <a class="btn btn-info" href="edu_deposit_process.php?x=initiated&id=<?php echo dec_enc('encrypt', $data['trans_id']); ?>" title="Comment"><i class="fa fa-comments-o" aria-hidden="true"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php } } ?>
                                                    </tbody>
