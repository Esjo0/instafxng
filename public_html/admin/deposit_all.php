...
$all_deposit_requests = $db_handle->fetchAssoc($result);
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-right"><a href="deposit_all_filter.php"  class="btn btn-default" title="Deposit All - Filter"><i class="fa fa-arrow-circle-right"></i> Deposit All - Filter</a></p>
                                <p>Below is the list of all deposit requests.</p>
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    if(isset($all_deposit_requests) && !empty($all_deposit_requests)) {
                                        foreach ($all_deposit_requests as $row) {
                                            ?>
                                            <tr>
                                ...
                                <?php if(isset($all_deposit_requests) && !empty($all_deposit_requests)) { ?>
                        ...
                        <?php if(isset($all_deposit_requests) && !empty($all_deposit_requests)) { require_once 'layouts/pagination_links.php'; } ?>
                    </div>
