...
$query = "SELECT ud.trans_id, ud.dollar_ordered, ud.created, ud.naira_total_payable, ud.real_dollar_equivalent, ud.real_naira_confirmed,
        ...
        WHERE ud.status = '4' OR ud.status = '7' ORDER BY ud.client_notified_date DESC ";
...
$declined_deposit_requests = $db_handle->fetchAssoc($result);
...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - Declined Deposit</title>
        <meta name="title" content="Instaforex Nigeria | Admin - Declined Deposit" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>DECLINED DEPOSIT</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>Below is a list of Deposit Transactions that were Declined/Disapproved either at the confirmation level or the funding level.</p>
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    if(isset($declined_deposit_requests) && !empty($declined_deposit_requests)) {
                                        foreach ($declined_deposit_requests as $row) {
                                            ?>
                                            <tr>
                                ...
                                <?php if(isset($declined_deposit_requests) && !empty($declined_deposit_requests)) { ?>
                        ...
                        <?php if(isset($declined_deposit_requests) && !empty($declined_deposit_requests)) { require_once 'layouts/pagination_links.php'; } ?>
                    </div>
