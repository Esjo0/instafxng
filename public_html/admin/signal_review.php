                                ...
                                <table  class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tr class="<?php table_context($row['trigger_status']) ?>">
                                        ...
                                        <td>
                                            ...
                                            <span><b>Date Created:</b> <?php echo date_format($row['created'], 'g:i \o\n l jS F Y'); ?></span><br/>
											<span><b>Keynote:</b> <?php echo $row['note']; ?>
                                        </td>
                                        <td>
                                            <span><b>Entry Price:</b> <?php echo $row['entry_price']; ?></span><br/>
                                            <span><b>Entry Time:</b> <?php if(!empty($row['entry_time'])){echo date_format($row['entry_time'], 'g:i \o\n l jS F Y');} ?></span><br/>
                                            <span><b>Exit Time:</b> <?php if(!empty($row['exit_time'])){echo date_format($row['exit_time'], 'g:i \o\n l jS F Y');} ?></span><br/>
