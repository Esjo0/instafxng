...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
    ...
    $query = "SELECT u.user_code, CONCAT(u.last_name, SPACE(1), u.first_name) AS full_name, u.email, u.phone, u.created
            ...
            LEFT JOIN user AS u ON uc.user_code = u.user_code
...
$selected_lev2_clients = $db_handle->fetchAssoc($result);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - Level Two Clients</title>
        <meta name="title" content="Instaforex Nigeria | Admin - Level Two Clients" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>LEVEL TWO CLIENTS</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>Below are clients who have passed the Level 2 Verification Stage, this means that they have also passed Level 1 Verification
                                    stage and have uploaded their documents (Valid ID, Passport, Signature) and the documents have been approved by an admin.</p>
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    if(isset($selected_lev2_clients) && !empty($selected_lev2_clients)) { foreach ($selected_lev2_clients as $row) {
                                        ?>
                                        <tr>
                                ...
                                <?php if(isset($selected_lev2_clients) && !empty($selected_lev2_clients)) { ?>
