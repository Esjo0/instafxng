                            ...
                            if(isset($pending_deposit_requests) && !empty($pending_deposit_requests)) {
                                foreach ($pending_deposit_requests as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="nowrap">
                                            <a class="btn btn-info" href="deposit_pay_notify.php?id=<?php echo encrypt_ssl($row['trans_id']); ?>" title="Payment Notification"><i class="fa fa-bell-o" aria-hidden="true"></i></a>
