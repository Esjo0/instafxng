                                    ...
                                    $supervisor_code = explode("," ,$row['supervisor_code']);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <br/>
                                                <br/>
                                                <button title="Add New Announcement" type="button" data-toggle="modal" data-target="#new_comment<?php echo $row['project_code'];?>" class="btn btn-info"><i class="glyphicon glyphicon-comment"></i></button>
