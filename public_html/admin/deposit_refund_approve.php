                            ...
                            if(isset($deposit_refund_pending) && !empty($deposit_refund_pending)) {
                                foreach ($deposit_refund_pending as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="nowrap">
                                            <a class="btn btn-info" href="deposit_process.php?x=refund_completed&id=<?php echo encrypt_ssl($row['trans_id']); ?>" title="Comment"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
