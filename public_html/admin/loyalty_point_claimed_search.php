...
if (isset($_POST['loyalty_point_claimed_view']) || isset($_GET['pg'])) {

    if(isset($_POST['loyalty_point_claimed_view'])) {
...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - Search Loyalty Point Claimed</title>
        <meta name="title" content="Instaforex Nigeria | Admin - Search Loyalty Point Claimed" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>SEARCH LOYALTY POINT CLAIMED</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                <p><a href="loyalty_point_claimed.php" class="btn btn-default" title=""><i class="fa fa-arrow-circle-left"></i> All Loyalty Point Claimed</a></p>
                                <?php require_once 'layouts/feedback_message.php'; ?>

                                <p>Choose a date range below and get report of claimed loyalty points.</p>
                                <p>To limit your search more, enter a search term in the space for search parameter.
                                    Your search parameter can be account number, name, email, phone number and date.
                                    Date should be in the format 2016-12-25.</p>
                                ...
                                <form data-toggle="validator" class="form-horizontal" role="form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9"><input name="loyalty_point_claimed_view" type="submit" class="btn btn-success" value="Display" /></div>
                                    </div>
