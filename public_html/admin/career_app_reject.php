...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - Career Rejected Applications</title>
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>CAREERS - REJECTED APPLICATION</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                <p>All rejected applications. Apply filter using the form below to choose a specific
                                    job category.</p>
