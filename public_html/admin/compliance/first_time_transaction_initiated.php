...
$query = "SELECT CONCAT(u.last_name, SPACE(1), u.first_name) AS client_full_name, u.phone, u.email,
    ...
    WHERE uft.status = '1' ORDER BY uft.created DESC ";
            ...
            <div class="row no-gutter">
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="section-tint super-shadow">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <p>Below is a list of clients that just initiated their first transaction. A system
                                email has been sent to them, please also initiate a call to them, record your comment
                                and approve, or disapprove if there is an issue.</p>
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <?php if(isset($first_time_transaction) && !empty($first_time_transaction)) { foreach ($first_time_transaction as $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a title="Edit" class="btn btn-info" href="compliance/first_time_transaction_view.php?id=<?php echo encrypt($row['trans_id']); ?>"><i class="glyphicon glyphicon-edit icon-white"></i> </a>
                                            </td>
                                        </tr>
