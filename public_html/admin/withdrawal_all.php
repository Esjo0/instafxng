                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-right"><a href="withdrawal_all_filter.php"  class="btn btn-default" title="Withdrawal All - Filter"><i class="fa fa-arrow-circle-right"></i> Withdrawal All - Filter</a></p>
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    if(isset($all_withdrawal_requests) && !empty($all_withdrawal_requests)) {
                                        foreach ($all_withdrawal_requests as $row) {
                                            ?>
                                            <tr>
