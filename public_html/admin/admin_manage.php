                            ...
                            <div class="col-sm-12">
                                ...
                                <form class="form-horizontal" role="form" method="post" action="<?php echo $REQUEST_URI; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4"><div class="checkbox"><label for=""><input type="checkbox" name="pageid[]" value="87b" id="" <?php if (in_array('87b', $my_pages)) { echo 'checked="checked"'; } ?>/> Compose Single SMS</label></div></div>
