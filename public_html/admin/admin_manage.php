                            ...
                            <div class="col-sm-12">
                                ...
                                <form class="form-horizontal" role="form" method="post" action="<?php echo $REQUEST_URI; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4"><div class="checkbox"><label for=""><input type="checkbox" name="pageid[]" value="283" id="" <?php if (in_array(283, $my_pages)) { echo 'checked="checked"'; } ?>/> Deposit Refund - Approve</label></div></div>
                                        <div class="col-sm-4"><div class="checkbox"><label for=""><input type="checkbox" name="pageid[]" value="284" id="" <?php if (in_array(284, $my_pages)) { echo 'checked="checked"'; } ?>/> Deposit Refund - Completed</label></div></div>
                                    </div>
                                    <hr/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4"><div class="checkbox"><label for=""><input type="checkbox" name="pageid[]" value="288" id="" <?php if (in_array(289, $my_pages)) { echo 'checked="checked"'; } ?>/> Clients On-Boarding</label></div></div>
                                    </div>
                                    <hr/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4"><div class="checkbox"><label for=""><input type="checkbox" name="pageid[]" value="288" id="" <?php if (in_array(287, $my_pages)) { echo 'checked="checked"'; } ?>/> Admin Targets</label></div></div>
                                    </div>
                                    <hr/>
