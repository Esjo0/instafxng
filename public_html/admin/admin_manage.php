                            ...
                            <div class="col-sm-12">
                                ...
                                <form class="form-horizontal" role="form" method="post" action="<?php echo $REQUEST_URI; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4"><div class="checkbox"><label for=""><input type="checkbox" name="pageid[]" value="320" id="" <?php if (in_array(420, $my_pages)) { echo 'checked="checked"'; } ?>/> Deposit - Confirmed (View Only)</label></div></div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4"><div class="checkbox"><label for=""><input type="checkbox" name="pageid[]" value="420" id="" <?php if (in_array(420, $my_pages)) { echo 'checked="checked"'; } ?>/> Withdrawal - Confirmed (View Only)</label></div></div>
