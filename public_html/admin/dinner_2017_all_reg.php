                            ...
                            <div class="col-sm-12">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                        ...
                                        <li role="presentation"><a onclick="show_form('search_form')" role="menuitem" tabindex="-1" href="<?php echo $_SERVER['PHP_SELF']; ?>#">Search By Name or Email</a></li>
                                        <li role="presentation" class="divider"></li>
                                        <li role="presentation"><a onclick="show_form('state_form')" role="menuitem" tabindex="-1" href="<?php echo $_SERVER['PHP_SELF']; ?>#">Filter By State Of Residence</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
