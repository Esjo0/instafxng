                                    ...
                                    <table class="table table-responsive table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_blank" title="Delete" class="btn btn-danger" href="client_delete_view.php?id=<?php echo encrypt_ssl($row['user_code']); ?>"><i class="glyphicon glyphicon-erase icon-white"></i> </a>
                                                </td>
                                            </tr>
