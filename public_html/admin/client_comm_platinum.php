                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    if(isset($selected_platinum_comm_clients) && !empty($selected_platinum_comm_clients)) { foreach ($selected_platinum_comm_clients as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td nowrap="nowrap">
                                                <a title="Comment" class="btn btn-success" href="sales_contact_view.php?x=<?php echo encrypt($row['user_code']); ?>&r=<?php echo 'client_comm_platinum'; ?>&c=<?php echo encrypt('PLATINUM COMMISSION CLIENTS'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
