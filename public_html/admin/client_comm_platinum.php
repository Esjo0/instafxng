...
$selected_platinum_comm_clients = $db_handle->fetchAssoc($result);
...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Admin - Platinum Commission Clients</title>
        <meta name="title" content="Instaforex Nigeria | Admin - Platinum Commission Clients" />
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>PLATINUM COMMISSION CLIENTS</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="section-tint super-shadow">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>The list of clients that produced $1k commission and above between December 1, 2017 to September 30, 2018</p>

                                <?php if(isset($numrows)) { ?>
                                    <p><strong>Result Found: </strong><?php echo number_format($numrows); ?></p>
                                <?php } ?>

                                <?php if(isset($selected_platinum_comm_clients) && !empty($selected_platinum_comm_clients)) { require 'layouts/pagination_links.php'; } ?>
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    if(isset($selected_platinum_comm_clients) && !empty($selected_platinum_comm_clients)) { foreach ($selected_platinum_comm_clients as $row) {
                                        ?>
                                        <tr>
                                            ...
                                            <td nowrap="nowrap">
                                                <a title="Comment" class="btn btn-success" href="sales_contact_view.php?x=<?php echo dec_enc('encrypt', $row['user_code']); ?>&r=<?php echo 'client_comm_platinum'; ?>&c=<?php echo dec_enc('encrypt', 'PLATINUM COMMISSION CLIENTS'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
                                ...
                                <?php if(isset($selected_platinum_comm_clients) && !empty($selected_platinum_comm_clients)) { ?>
