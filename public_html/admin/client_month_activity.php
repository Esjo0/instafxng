                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover">
                            ...
                            if(isset($clients_activity) && !empty($clients_activity)) { foreach ($clients_activity as $row) {
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <a title="View" target="_blank" class="btn btn-info" href="client_detail.php?id=<?php echo encrypt_ssl($row['user_code']); ?>"><i class="glyphicon glyphicon-eye-open icon-white"></i> </a>
                                        <a title="Comment" target="_blank" class="btn btn-success" href="sales_contact_view.php?x=<?php echo encrypt_ssl($row['user_code']); ?>&r=<?php echo 'client_month_activity'; ?>&c=<?php echo encrypt_ssl('CLIENT MONTH ACTIVITY'); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
