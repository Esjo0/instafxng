...
$query = "SELECT CONCAT(last_name, SPACE(1), first_name) AS full_name, email_address, phone_number, cua.career_user_application_id, cj.title, cua.created, cua.status
