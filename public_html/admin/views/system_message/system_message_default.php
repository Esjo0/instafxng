...
<table class="table table-responsive table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a title="Edit" class="btn btn-info" href="system_message.php?action=update&id=<?php echo encrypt_ssl($row['system_message_id']); ?>"><i class="glyphicon glyphicon-edit icon-white"></i> Edit</a>
                <a title="Send Test" class="btn btn-info" href="system_message.php?action=test&id=<?php echo encrypt_ssl($row['system_message_id']); ?>"><i class="fa fa-paper-plane fa-fw"></i> </a>
            </td>
        </tr>
