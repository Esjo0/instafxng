                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a title="Edit" class="btn btn-default" href="career_new_job.php?x=edit&id=<?php echo dec_enc('encrypt', $row['career_jobs_id']); ?>"><i class="glyphicon glyphicon-edit icon-white"></i> </a>
                                            </td>
                                        </tr>
