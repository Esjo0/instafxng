...
$pending_moderation = $bonus_operations->get_defaulting_accounts();
                ...
                <div id="main-body-content-area" class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            <h4><strong>REVIEW DEFAULTING BONUS ACCOUNTS</strong></h4>
                        </div>
                    </div>
                                    ...
                                    <?php if(isset($pending_moderation) && !empty($pending_moderation)){ ?>
                                        <?php foreach($pending_moderation as $row){ extract($row);?>
                                            <tr>
                                                ...
                                                <td class="nowrap"><a class="btn-xs btn btn-default" href="bonus_defaulting_view.php?app_id=<?php echo dec_enc('encrypt', $row['app_id']);?>"><i class="glyphicon glyphicon-arrow-right"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    <?php }else{ ?>
