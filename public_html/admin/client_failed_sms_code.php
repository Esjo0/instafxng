                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    if(isset($failed_sms_code) && !empty($failed_sms_code)) { foreach ($failed_sms_code as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a title="Comment" class="btn btn-success" href="client_failed_sms_code_comment.php?x=<?php echo encrypt_ssl($row['user_code']); ?>&pg=<?php echo $currentpage; ?>"><i class="glyphicon glyphicon-comment icon-white"></i> </a>
