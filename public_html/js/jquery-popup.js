...
(function($) {
    $.hunterPopup = function(box, options) {
        ...
        var template = $('<div class="Hunter-pop-up" id="Hunter-pop-up"><a class="close"><i class="glyphicon glyphicon-remove"></i></a><div class="arrow"></div><center><h5 class="title"></h5></center><div id="Hunter_pop_wrap" class="Hunter-wrap"></div></div>');
