...
<html lang="en">
    <head>
        ...
        <title>InstaFxNg Predict & Win Promo</title>
        ...
        <style>
            .float{
                ...
                bottom:20px;
                right:20px;
                background-color: rgb(255, 167, 163);
                color: #ffffff;
                border-radius:30px;
                text-align:center;
        ...
        <script><?php require_once 'assets/js/app.js'; ?></script>
    </head>
    <body>
        <!-- Start Header -->
                    ...
                    <div class="container">
                        <div class="mu-footer-area">
                            ...
                            <div class="mu-footer-bottom">
                                <p class="mu-copy-right">&copy; Copyright <a rel="nofollow" href="https://instafxng.com">Instaforex Nigeria (www.instafxng.com)</a>. All rights reserved.</p>
                            </div>
                        </div>
                    </div>
                </footer>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row">
                                <div class="col-sm-12">
                                    <img class="img-responsive" src="assets/images/lfc_rma.jpg">
                                </div>
                            </div>
                            <br/>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <form id="ud_form" data-toggle="validator" class="form-horizontal" role="form" method="post" action="">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input name="UserDetails_nn" id="UserDetails_nn" type="text" placeholder="Nickname"  class="form-control" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="input-group  input-group-sm">
                                                    ...
                                                    <input name="UserDetails_fn" id="UserDetails_fn" type="text" placeholder="Full Name" class="form-control" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="input-group  input-group-sm">
                                                    ...
                                                    <input name="UserDetails_ea" id="UserDetails_ea" type="text" placeholder="Email Address" class="form-control" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="input-group  input-group-sm">
                                                    ...
                                                    <input name="UserDetails_pn" id="UserDetails_pn" type="text" placeholder="Phone Number" class="form-control" required/>
                                                </div>
                                            </div>
                                        </div>
										<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button type="button" onclick="sports_pred.Process_User_Details()" id="submit_ud" class="btn btn-group-justified btn-sm btn-default">Submit</button>
                                            </div>
                                        </div>
						...
						<p><b>Join The Conversation</b></p>
                            <div id="msg_container" style="height: 540px; overflow-y: scroll;">
                                ...
                                <div style="display: none;" id="new_msg" class="w3-card-4">
                                    <header class="w3-container"><h3></h3></header>
                                    <div class="w3-container">
                                        <textarea onblur="sports_pred.MsgBoxOnBlur()" class="form-control" id="new_msg_textbox" rows="2"></textarea>
                                    </div>
