...
<html lang="en">
    <head>
        ...
        <title>Instaforex Nigeria | Education Bonus</title>
        <meta name="title" content="Instaforex Nigeria | Education Bonus" />
            ...
            <div class="row no-gutter">
                ...
                <div id="main-body-content-area" class="col-md-8 col-md-push-4 col-lg-9 col-lg-push-3">
                    ...
                    <div class="super-shadow page-top-section">
                        <div class="row ">
                            <div class="col-sm-6">
                                <h2>Instaforex Forex Education Bonus</h2>
                            ...
                            <div class="col-sm-6">
                                <img src="images/instaforex_education_bonus.png" alt="" class="img-responsive" />
                            </div>
                        </div>
                    </div>

                    <div class="section-tint super-shadow">
                        <h5>Please follow the steps below to claim your 100% Forex Education Bonus.</h5>
                        <ol>
