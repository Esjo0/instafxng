                ...
                <div id="main-body-content-area" class="col-md-8 col-md-push-4 col-lg-9 col-lg-push-3">
                    ...
                    <?php foreach ($all_bonus_packages as $row){ extract($row); ?>
                            <div class="section-tint super-shadow">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <a href="bonus_view.php?bc=<?php echo encrypt_ssl($bonus_code); ?>" title="click for full details" target="_blank">
                                            <img src="images/bonus_packages/<?php echo $bonus_img; ?>" alt="" class="img-responsive" />
                                        </a>
                                    </div>
                                    <div class="col-sm-8">
                                        <p><?php echo $bonus_desc; ?></p>
                                        <a class="btn btn-success" href="bonus_view.php?bc=<?php echo encrypt_ssl($bonus_code); ?>" title="click for full details" target="_blank">More Details</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
