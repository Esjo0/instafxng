                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapse<?php echo $count; ?>" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p class="text-right"><a title="Apply Now" class="btn btn-success btn-bg" href="careers_apply.php?c=<?php echo dec_enc('encrypt', $row['job_code']); ?>"><i class="fa fa-paper-plane-o icon-white"></i> Apply Now</a></p>
                                                <?php echo $row['detail']; ?>
                                                <p class="text-right"><a title="Apply Now" class="btn btn-success btn-bg" href="careers_apply.php?c=<?php echo dec_enc('encrypt', $row['job_code']); ?>"><i class="fa fa-paper-plane-o icon-white"></i> Apply Now</a></p>
                                            </div>
                                        </div>
