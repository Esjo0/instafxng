...
<head>
    ...
    <script>
        signal.getMainSignals('sign');
        //$(document).ready(function() {setInterval(function(){signal.getMainSignals('sign');}, 60000);});
    </script>
</head>
<body>
                                ...
                                <div id="collapse3" class="panel-collapse collapse">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-sm-6">
                                            ...
                                            <p style="border-radius: 50%;">
                                                <span><strong><u>KEYNOTE</u></strong></span>
                                                xchjnxhnx hjidsi hdi hdo sdj sidjs dhsio djsdjsdjosdj sjdshd shd osdj shd sdhs dhsd sdhisduhsi dh
                                            </p>
                                        </div>
                                        <div class="col-sm-6">
                                            <section style="min-height: 300px;">
