...
OverlayChatWidgetV2.TextInlineButtonWidth = 200;
OverlayChatWidgetV2.TextInlineButtonWidthMobile = 130;
...
//OverlayChatWidgetV2.ModeActivelySelected = false;
...
function lz_chat_add_wm_elems(_template,_ml,_mt,_mr,_mb,_chatAvailable){
    ...
    OverlayChatWidgetV2.ButtonTexts = (!lz_is_mobile) ? lz_text_wm : lz_text_wm_s;
    ...
    if(OverlayChatWidgetV2.__ModeTextInline)
        OverlayChatWidgetV2.__SizeWidth = (!lz_is_mobile) ? OverlayChatWidgetV2.TextInlineButtonWidth : OverlayChatWidgetV2.TextInlineButtonWidthMobile;
    ...
    if(lz_overlay_wm == null && !OverlayChatWidgetV2.__ModeCombi)
    {
        ...
        var cheight = (lz_ovlel_fsm) ? '50' : (OverlayChatWidgetV2.__SizeHeight+OverlayChatWidgetV2.__Border)+OverlayChatWidgetV2.__Space;
        ...
        for(var y=lz_ovlel.length-1;y>=0;y--)
        {
            ...
            if(lz_ovlel[i].type != 'wm')
            {
                ...
                if(lz_ovlel[i].type != 'phone')
                    clnd.innerHTML = OverlayChatWidgetV2.ButtonTexts[lz_ovlel[i].type];
                else
                {
                    clnd.innerHTML = "";
                    if(lz_ovlel[i].inbound != false)
                        clnd.innerHTML += OverlayChatWidgetV2.ButtonTexts['phone_in'];

                    if(lz_ovlel[i].inbound != false && lz_ovlel[i].outbound != false)
                        clnd.innerHTML += ' / ';

                    if(lz_ovlel[i].outbound != false)
                        clnd.innerHTML += OverlayChatWidgetV2.ButtonTexts['phone_out'];
                }

                clnd.style.marginTop = '-' +((OverlayChatWidgetV2.__SizeHeight+OverlayChatWidgetV2.__Border)-VARSA)+ 'px';
                ...
                if(OverlayChatWidgetV2.__ModeTextInline)
                {
                    wmd.style.marginLeft = clnd.style.marginLeft = (OverlayChatWidgetV2.__SizeHeight-10) + 'px';
                    ...
                    wmd.style.width = clnd.style.width = (OverlayChatWidgetV2.__SizeWidth-60)+'px';
                    ...
                    wmd.style.marginTop = '-' +((OverlayChatWidgetV2.__SizeHeight+OverlayChatWidgetV2.__Border)-VARSA)+ 'px';
                }
                ...
                try
                {
                    ...
                    if(document.getElementById("lz_form_active_" + findex).value == "true" || (lz_session.OVLWMSElem=="phone" && findex == 116))
                    {
                        ...
                        if(document.getElementById("lz_form_info_" + findex).innerHTML.length > 0 && !OverlayChatWidgetV2.__ModeChangeDetails)
                        {
                            ...
                            document.getElementById("lz_form_mandatory_" + findex).onmouseover = function(){'lz_chat_show_info_box(\''+findex.toString()+'\',true);'};
                            document.getElementById("lz_form_mandatory_" + findex).onmouseout = function(){"lz_chat_show_info_box('"+findex.toString()+"',false);"};
                            document.getElementById("lz_form_mandatory_" + findex).onclick = function(){"lz_chat_show_info_box('"+findex.toString()+"',true);"};
                            document.getElementById("lz_form_info_" + findex).onclick = function(){"lz_chat_show_info_box('"+findex.toString()+"',false);"};
                        }
                        else if(OverlayChatWidgetV2.__ModeChangeDetails)
                            document.getElementById("lz_form_mandatory_" + findex).style.display = 'none';
...
OverlayChatWidgetV2.UpdateWMIcon = function(cln){
    ...
    var vbdef = '-12 -11 48 48';
    var trdef = 'scale(.014)';
    if(lz_session.OVLWMState == '1')
    {
        cln.getElementsByTagName('path')[0].setAttribute("d", lz_get_icon_path('close'));
        cln.getElementsByTagName('svg')[0].setAttribute("viewBox", vbdef);
        cln.getElementsByTagName('path')[0].setAttribute("transform", trdef);
    }
    else
    {
        ...
        else if(lz_chat_get_wm_element('chat') == null || !OverlayChatWidgetV2.IsChatAvailable())
        {
            if(lz_chat_get_wm_element('ticket') != null)
            {
                cln.getElementsByTagName('path')[0].setAttribute("d", lz_get_icon_path('envelope'));
                cln.getElementsByTagName('svg')[0].setAttribute("viewBox", vbdef);
                cln.getElementsByTagName('path')[0].setAttribute("transform", trdef);
            }
            else
