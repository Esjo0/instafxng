...
ServerConfiguration.prototype.GetCustomForm = function(formType, obj) {
    ...
    if(formType == 'EmailAccounts'){
        ...
        contentHtml += lzm_inputControls.createButton('ihelpbutton','','window.open(\'https://www.livezilla.net/faq/en/?fid=custom-chat-input-fields\');', tid('help'), '', '', {'padding': '5px 15px', 'margin-right':'6px'}, '', 30, 'd');
