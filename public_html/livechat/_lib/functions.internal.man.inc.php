...
class ServerManager
{
    ...
    static function ExportData()
    {
        ...
        if(OperatorRequest::IsValidated() && OperatorRequest::IsAdministrator(true))
        {
            $tables = array(DATABASE_CHAT_ARCHIVE,DATABASE_TICKETS,DATABASE_TICKET_MESSAGES);
            ...
            if(in_array($_POST["p_export_table"],$tables) && in_array($_POST["p_export_format"],$formats))
            {
                ...
                $sql .= $sql_fields . " FROM `" . DB_PREFIX . $_POST["p_export_table"] . "`";
                ...
                KnowledgeBase::CreateEntry(CALLER_SYSTEM_ID, $fileId, $fileMask, 3, "data_export_" . time() . "." . strtolower($_POST["p_export_format"]), 0, CALLER_SYSTEM_ID, 500);
            }
        }
    }
}
